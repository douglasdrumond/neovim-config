...
-- Hop
map("n", "<C-h>", "<cmd>lua require'hop'.hint_words()<cr>")
map("n", "<C-l>", "<cmd>lua require'hop'.hint_lines()<cr>")
map("v", "<C-h>", "<cmd>lua require'hop'.hint_words()<cr>")
map("v", "<C-l>", "<cmd>lua require'hop'.hint_lines()<cr>")
